...
pdata_reduced$Global_active_power <- as.numeric(pdata_reduced$Global_active_power)
pdata_reduced$Global_reactive_power <- as.numeric(pdata_reduced$Global_reactive_power)
pdata_reduced$Voltage <- as.numeric(pdata_reduced$Voltage)
...
## plot the 4 graphs
par(mfrow=c(2,2))
with(pdata_reduced, plot(DateTime, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
with(pdata_reduced, plot(DateTime, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
with(pdata_reduced, {
...
with(pdata_reduced, plot(DateTime, Global_reactive_power, type="l", xlab="datetime",
